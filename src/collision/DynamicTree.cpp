...
{
    bool did_hit;
    G3D::uint32 phase_mask;
    DynamicTreeIntersectionCallback(G3D::uint32 phasemask) : did_hit(false), phase_mask(phasemask) { }
...
struct DynamicTreeIntersectionCallback_WithLogger
{
    bool did_hit;
    G3D::uint32 phase_mask;
    DynamicTreeIntersectionCallback_WithLogger(G3D::uint32 phasemask) : did_hit(false), phase_mask(phasemask)
    {
...
bool DynamicMapTree::getIntersectionTime(const G3D::uint32 phasemask, const G3D::Ray& ray,
...
bool DynamicMapTree::getObjectHitPos(const G3D::uint32 phasemask, const G3D::Vector3& startPos,
...
bool DynamicMapTree::isInLineOfSight(float x1, float y1, float z1, float x2, float y2, float z2, G3D::uint32 phasemask) const
{
...
float DynamicMapTree::getHeight(float x, float y, float z, float maxSearchDist, G3D::uint32 phasemask) const
{
    G3D::Vector3 v(x, y, z);
