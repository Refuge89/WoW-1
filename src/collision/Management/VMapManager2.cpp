...
namespace VMAP
{
    ...
    void VMapManager2::InitializeThreadUnsafe(std::vector<G3D::uint32>& mapIds)
    {
    ...
    InstanceTreeMap::const_iterator VMapManager2::GetMapTree(G3D::uint32 mapId) const
    {
    ...
    bool VMapManager2::_loadMap(G3D::uint32 mapId, const std::string& basePath, G3D::uint32 tileX, G3D::uint32 tileY)
    {
    ...
    */
    ...
    bool VMapManager2::getAreaInfo(unsigned int mapId, float x, float y, float& z, G3D::uint32& flags, int32& adtId, int32& rootId, int32& groupId) const
    {
    ...
    bool VMapManager2::GetLiquidLevel(G3D::uint32 mapId, float x, float y, float z, G3D::uint8 reqLiquidType, float& level, float& floor, G3D::uint32& type) const
    {
