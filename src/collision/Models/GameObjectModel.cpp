...
typedef std::unordered_map<G3D::uint32, GameobjectModelData> ModelList;
...
void LoadGameObjectModelList(std::string const& dataPath)
{
    ...
    Log.Warning("LoadGameObjectModelList", "Loaded %u GameObject models in %u ms", G3D::uint32(model_list.size()), GetMSTimeDiffToNow(startTime));
}
...
bool GameObjectModel::intersectRay(const G3D::Ray& ray, float& MaxDist, bool StopAtFirstHit, G3D::uint32 ph_mask) const
{
