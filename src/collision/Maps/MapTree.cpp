...
namespace VMAP
{
    ...
    bool StaticMapTree::getAreaInfo(Vector3 &pos, G3D::uint32 &flags, int32 &adtId, int32 &rootId, int32 &groupId) const
    {
    ...
    */
    ...
    bool StaticMapTree::isInLineOfSight(const Vector3& pos1, const Vector3& pos2) const
    {
        ...
        if (maxDist == std::numeric_limits<float>::max() || !G3D::isFinite(maxDist))
            return false;
    ...
    */
    ...
    bool StaticMapTree::InitMap(const std::string &fname, VMapManager2* vm)
    {
        ...
        ModelSpawn spawn;
#ifdef VMAP_DEBUG
        LOG_DEBUG("map isTiled: %u", static_cast<G3D::uint32>(iIsTiled));
#endif
