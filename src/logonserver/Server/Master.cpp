...
{
    sLog.outBasic(BUILD_TAG, BUILD_HASH_STR, CONFIG, PLATFORM_TEXT, ARCH);
    sLog.outBasic("========================================================");
    sLog.outErrorSilent(BUILD_TAG, BUILD_HASH_STR, CONFIG, PLATFORM_TEXT, ARCH); // Echo off.
...
/*
    ...
    realmID = Config.RealmConfig.GetIntDefault("RealmsDatabase", "RealmID", 1);
    if(!realmID)
    {
