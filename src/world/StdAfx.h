...
#define TO_VEHICLE(ptr) TO<Vehicle*>(ptr)
#define TO_POSSEEEDSUMMON(ptr) TO<PossessedSummon*>(ptr)
...
#include "../collision/Maps/MapDefines.h"
...
#define RECRUITING "Info: |cff00FF7FAbdUlRahman is recruiting developer: Join me on github.com #AscEnt"
#define BUGTRACKER "https://github.com/Abd-ulRahman/AscEnt/issues"
