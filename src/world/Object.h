...
class SERVER_DECL Object : public EventableObject
{
	public:
		...
		bool IsVehicle() { return m_isVehicle; }
		...
		void SetSpawnX(float x) { m_spawnLocation.x = x; }
		void SetSpawnY(float y) { m_spawnLocation.y = y; }
		void SetSpawnZ(float z) { m_spawnLocation.z = z; }
		void SetSpawnO(float o) { m_spawnLocation.o = o; }
