...
class SERVER_DECL Player : public Unit
{
	...
	public:
        ...
        Difficulty GetDifficulty(bool isRaid) { return isRaid ? Difficulty(m_RaidDifficulty) : Difficulty(iInstanceType); }
		...
		******************/
		...
		void UnPossess();
//		bool UnPossessed(Unit* pTarget);
//		void EnterVehicle( uint64 guid, uint32 delay = 0 );
...
//		void RemoveFromVehicle( Unit* Target, uint32 delay = 0 );
