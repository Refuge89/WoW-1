...
{
	Log.Warning("DatabaseCleaner", "Stage 1 of 3: Cleaning characters...");
	CleanCharacters();

	Log.Warning("DatabaseCleaner", "Stage 2 of 3: Cleaning world...");
	CleanWorld();

	Log.Warning("DatabaseCleaner", "Stage 3 of 3: Optimizing databases...");
	Optimize();
}
...
void DatabaseCleaner::CleanCharacters()
{
	...
	Log.Warning("DatabaseCleaner", "Loading guids...");
	...
	Log.Warning("DatabaseCleaner", "Got %u guids.", chr_guids.size());
	Log.Warning("DatabaseCleaner", "Cleaning playeritems...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u item instances.", tokill_items.size());
	Log.Warning("DatabaseCleaner", "Cleaning questlog...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u questlog entries.", tokill_quests.size());
	Log.Warning("DatabaseCleaner", "Cleaning corpses...");
	...
	Log.Warning("DatabaseCleaner", "Removed %u corpses.", tokill_corpses.size());
	Log.Warning("DatabaseCleaner", "Cleaning mailbox...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u mail messages.", tokill_mail.size());
	Log.Warning("DatabaseCleaner", "Cleaning guilds table...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u guilds.", tokill_guilds.size());
	Log.Warning("DatabaseCleaner", "Cleaning guild_ranks table...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u guild rank rows.", tokill_guildranks.size());
	Log.Warning("DatabaseCleaner", "Cleaning social table...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u social entries.", tokill_social.size());
	Log.Warning("DatabaseCleaner", "Cleaning cooldown tables...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u playercooldownitems.", tokill_cool.size() + tokill_cool2.size());
	tokill_cool.clear();
	tokill_cool2.clear();
	...
	Log.Warning("DatabaseCleaner", "Deleted %u playercooldownsecurities.", tokill_cool.size() + tokill_cool2.size());
	Log.Warning("DatabaseCleaner", "Cleaning tutorials...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u tutorials.", tokill_tutorials.size());
	Log.Warning("DatabaseCleaner", "Cleaning playerpets...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u pets.", tokill_pet.size());
	Log.Warning("DatabaseCleaner", "Cleaning playersummonspells...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u summonspells.", tokill_ss.size());
	Log.Warning("DatabaseCleaner", "Cleaning playerpetspells...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u petspells.", tokill_ps.size());
	Log.Warning("DatabaseCleaner", "Cleaning gm_tickets...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u gm tickets.", tokill_gm.size());
	Log.Warning("DatabaseCleaner", "Cleaning charters...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u charters.", tokill_charters.size());
	Log.Warning("DatabaseCleaner", "Cleaning charters...");
	...
	Log.Warning("DatabaseCleaner", "Deleted %u auctions.", tokill_auct.size());
	Log.Warning("DatabaseCleaner", "Ending...");
}
