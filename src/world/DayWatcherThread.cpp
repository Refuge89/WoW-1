...
void DayWatcherThread::load_settings()
{
	...
	{
		Log.Warning("DayWatcherThread", "Initializing Arena Updates to zero.");
		last_arena_time = 0;
	}
	...
	{
		Log.Warning("DayWatcherThread", "Initializing Daily Updates to zero.");
		last_daily_time = 0;
	}
}
...
{
	Log.Warning("DayWatcherThread", "Running Daily Quest Reset...");
...
{
	Log.Warning("DayWatcherThread", "Running Weekly Arena Point Maintenance...");
