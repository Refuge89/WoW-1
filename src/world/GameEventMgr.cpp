...
void GameEventMgr::LoadFromDB()
{
    ...
    Log.Warning("GameEventMgr:"," Start cleaning event_save");
    {
	...
	Log.Warning("GameEventMgr", "Start loading event_save");
    {
	...
	Log.Warning("GameEventMgr", "Start loading game event creature spawns");
    {
	...
	Log.Warning("GameEventMgr", "Start loading game event gameobject spawns");
    {
...
{
	Log.Warning("GameEventMgr", "Shutdown!");
