...
enum AI_Agent			// type
{
	...
	AGENT_FLEE,			//	FLEE
	AGENT_SPELL,		//	SPELL
	AGENT_CALLFORHELP	//	CALLFORHELP
};

enum AI_SpellType // spelltype
{
	STYPE_NULL,
	STYPE_ROOT,		// ROOT
	STYPE_DAMAGE,	// DAMAGE
	STYPE_AOEDAMAGE,// AOEDAMAGE
	STYPE_INTERRUPT,  // SILENCE   INTERRUPT
	STYPE_FEAR,		// FEAR
	STYPE_STUN,		// STUN
	STYPE_BUFF,		// BUFF
	STYPE_DEBUFF,	// DEBUFF
...
enum AI_SpellTargetType // targettype
{
	TTYPE_NULL,
	TTYPE_SINGLETARGET,	// RANDOMTARGET
	TTYPE_DESTINATION,	// TARGETLOCATION
	TTYPE_SOURCE,		// CREATURELOCATION
	TTYPE_CASTER,		// SELF
	TTYPE_OWNER,		// OWNER
};
