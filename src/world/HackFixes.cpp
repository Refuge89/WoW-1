...
//	sp = CheckAndReturnSpellEntry(35844);
//	if(sp != NULL)
//	{
//		sp->Effect[0] = SPELL_EFFECT_APPLY_AURA; //making this only for the visible effect
//		sp->EffectApplyAuraName[0] = SPELL_AURA_DUMMY; //no effect here
...
/*
	sp = CheckAndReturnSpellEntry(52589);
	if(sp != NULL)
	{
	...
	sp = CheckAndReturnSpellEntry(52588);
	if(sp != NULL)
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_MOUNTED;
		sp->EffectApplyAuraName[1] = SPELL_AURA_MOD_INCREASE_MOUNTED_SPEED;
...
/*
	...
	sp = CheckAndReturnSpellEntry(52694);
	if(sp != NULL)
	{
		sp->Effect[0] = SPELL_EFFECT_DUMMY;
	}
...
//***************Siege Vehicles SpellFixes********************//
	...
	// Scarlet Cannon
	sp = CheckAndReturnSpellEntry(52436);
	if(sp != NULL)
	{
	...
	sp = CheckAndReturnSpellEntry(50999);
	if(sp != NULL)
	{
		sp->EffectImplicitTargetA[0] = 89;
		sp->EffectImplicitTargetA[1] = 89;
	...
	sp = CheckAndReturnSpellEntry(50026);
	if(sp != NULL)
	{
		sp->EffectImplicitTargetA[0] = 89;
		sp->EffectImplicitTargetA[1] = 89;
	...
	// Deativate Electric chock on vehicle it self
	sp = CheckAndReturnSpellEntry(52576);
	if(sp != NULL)
	{
		sp->EffectImplicitTargetA[0] = EFF_TARGET_TARGET_AT_ORIENTATION_TO_CASTER;
		sp->EffectImplicitTargetA[1] = EFF_TARGET_TARGET_AT_ORIENTATION_TO_CASTER;
	}

//***************End of Vehicles SpellFixes********************//

	sp = CheckAndReturnSpellEntry(53173);
	if(sp != NULL)
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_MOUNTED;
		sp->EffectApplyAuraName[1] = SPELL_AURA_MOD_INCREASE_MOUNTED_SPEED;
	...
	sp = CheckAndReturnSpellEntry(51858);
	if(sp != NULL)
	{
		sp->Effect[ 0 ] = SPELL_EFFECT_DUMMY;
	//	sp->EffectApplyAuraName[ 0 ] = SPELL_AURA_DUMMY;
...
/*
	sp = CheckAndReturnSpellEntry(53063);
	if(sp != NULL)
	{
		sp->Effect[0] = SPELL_EFFECT_APPLY_AURA;
		sp->EffectApplyAuraName[0] = SPELL_AURA_DUMMY;
