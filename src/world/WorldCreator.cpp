...
MapMgr* InstanceMgr::_CreateInstance(uint32 mapid, uint32 instanceid)
{
	...
	Log.Warning("InstanceMgr", "Creating continent %s.", m_maps[mapid]->GetName());
...
MapMgr* InstanceMgr::_CreateInstance(Instance* in)
{
	...
	Log.Warning("InstanceMgr", "Creating saved instance %u (%s)", in->m_instanceId, m_maps[in->m_mapId]->GetName());
